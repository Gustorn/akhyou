...
public class PersistentCookieStore implements CookieStore
 {
    ...
    private void loadAllFromPersistence() {
        ...
        for (Map.Entry<String, ?> entry : allPairs.entrySet()) {
            ...
            try {
                ...
                SerializableHttpCookie serializableCookie = GeneralUtils.decode(encodedCookie, SerializableHttpCookie.class);
                HttpCookie cookie = serializableCookie.getCookie();
    ...
    private void saveToPersistence(URI uri, HttpCookie cookie) {
        ...
        editor.putString(uri.toString() + SP_KEY_DELIMITER + cookie.getName(),
                         GeneralUtils.encode(new SerializableHttpCookie(cookie)));
