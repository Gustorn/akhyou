...
import dulleh.akhyou.episode.Episode;
...
public class KissAnimeProvider implements AnimeProvider {
    ...
    @Override
    public List<Source> fetchSources(Anime anime) throws OnErrorThrowable {
        String body = GeneralUtils.getWebPage(anime.getImageUrl()); // TODO(gustorn): actual lookup
