...
public class AnimeAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder viewHolder, final int position) {
        ...
        Picasso.with(animeFragment.getActivity())
                ...
                .into(headerViewHolder.coverImage, new Callback.EmptyCallback() {
                    @Override
        ...
        headerViewHolder.genres.setText(anime.getGenreString());
        headerViewHolder.synopsis.setText(anime.getSynopsis());
        headerViewHolder.alternateTitle.setText(anime.getAlternateTitle());
        headerViewHolder.date.setText(anime.getAiringString());
        headerViewHolder.status.setText(anime.getStatus());
        headerViewHolder.favoriteButton.setImageDrawable(favoriteIcon());
    }
